...
class Part1Problem2(Slide, DistributionTemplate, FrequencyTableTemplate):
    ...
    def show_solution(self):
        ...
        sq2 = self.reveal_term(r"\pm\sqrt{5.75}", after=sq_eq, source=f2)
        ...
        ev2 = self.reveal_term(r"\pm 2.398", after=ev_eq, source=sq2)
        self.finish_line([ev1, ev_eq, ev2])

        # --- isolate x ---
        iso_line = self.reveal_term(r"x = -2 \pm 2.398", after=None, source=None, indicate=False)
